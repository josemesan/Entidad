...
public class LineaResourceIntTest {
    ...
    private static final Integer DEFAULT_NUMERO_DE_TRENES = 1;
    private static final Integer UPDATED_NUMERO_DE_TRENES = 2;
    ...
    public static Linea createEntity(EntityManager em) {
        Linea linea = new Linea()
            .numeroDeTrenes(DEFAULT_NUMERO_DE_TRENES);
        return linea;
    }
    ...
    public void createLinea() throws Exception {
        ...
        assertThat(testLinea.getNumeroDeTrenes()).isEqualTo(DEFAULT_NUMERO_DE_TRENES);
    }
    ...
    public void getAllLineas() throws Exception {
        ...
        restLineaMockMvc.perform(get("/api/lineas?sort=id,desc"))
            ...
            .andExpect(jsonPath("$.[*].numeroDeTrenes").value(hasItem(DEFAULT_NUMERO_DE_TRENES)));
    }
    ...
    public void getLinea() throws Exception {
        ...
        restLineaMockMvc.perform(get("/api/lineas/{id}", linea.getId()))
            ...
            .andExpect(jsonPath("$.numeroDeTrenes").value(DEFAULT_NUMERO_DE_TRENES));
    }
    ...
    public void updateLinea() throws Exception {
        ...
        updatedLinea
            .numeroDeTrenes(UPDATED_NUMERO_DE_TRENES);
        ...
        Linea testLinea = lineaList.get(lineaList.size() - 1);
        assertThat(testLinea.getNumeroDeTrenes()).isEqualTo(UPDATED_NUMERO_DE_TRENES);
    }
