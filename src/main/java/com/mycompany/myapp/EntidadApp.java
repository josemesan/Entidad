...
public class EntidadApp {
    ...
    private static final Logger log = LoggerFactory.getLogger(EntidadApp.class);

    private final Environment env;

    public EntidadApp(Environment env) {
        this.env = env;
    }
    ...
    public static void main(String[] args) throws UnknownHostException {
        SpringApplication app = new SpringApplication(EntidadApp.class);
